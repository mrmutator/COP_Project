...
To represent utterances as dense distributional vectors we use techniques from \newcite{le2014distributed}. How these representations are found will be explained in this section, where we start with word embeddings as proposed by \newcite{mikolov2013efficient} and then extend this to find embeddings for a sequence of words of an arbitrary length.
