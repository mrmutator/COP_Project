...
The results can be seen in Table~\ref{tab:results}. \david{Report best baseline explicitly here}.
...
In Table~\ref{tab:results} the results are presented. \david{Report best result here}
...
The results for both approaches can also be seen in Table~\ref{tab:results}. \david{Also here, best result in text}
