...
%	\item ...
%\end{itemize}
\subsection{Evaluating Sentence Models}
\david{results from the huge table we have online, find a nice way to summarize this}


\subsection{Intersecting Sentence and Discourse Models}
\david{Baseline}

\david{Using 'best' sentence models from last subsection}
